...
--llaves foraneas
    ...
    ALTER TABLE supervisa ADD CONSTRAINT supervisa_programadeporte_fk  FOREIGN KEY (id_programas_deporte) REFERENCES public.programa_deporte(id) ON UPDATE CASCADE;-- Progrma deporte - supervisa
    --fk beneficia
